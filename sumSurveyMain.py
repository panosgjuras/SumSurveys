...
# from sumSurveyDiariesProc import 
...
# from sumAssessAnalysis import acceptHist2, satisfyHist2
...
# 1. Creation of the Perception Assessment Dataframe
col = ['pid', 'city'] + sele
...
# 2. Creation of the Diaries Dataframe
col3 = ['pid', 'city'] + attr
